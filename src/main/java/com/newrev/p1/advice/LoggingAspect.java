...
public class LoggingAspect {
    ...
    @Before("execution(* com.newrev.p1.services.ProductServiceImpl.*(..))")
    public void doLog() {
        logger.info("2.###I am doing the logging from aspect");
    }

    @After("execution(* com.newrev.p1.services.ProductServiceImpl.*(..))")
    public void doSecurityCheck() {
        logger.info("3.###I am doing security checking");
    }

//    @Around("execution(* com.revature.project.services.ProductServiceImpl.addProduct(..))")
